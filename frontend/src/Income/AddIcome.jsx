      ...
      <div className="grid grid-cols-1 md:grid-cols-4 ">
        ...
        <div className=" md:col-span-2">
          ...
          <div className="h-20 w-60 z-0 mt-40 md:mt-0 ml-20">
            <h1 className="font-mono text-lg font-bold">Add Income</h1>

            <div className="mt-10">
              <p className="font-poppins font-bold"> Title of your Income</p>
              <input
                value={title}
                onChange={(event) => {
            ...
            <div className="mt-5">
              <p className="font-poppins font-bold"> Enter Income Source</p>
              <Select
                options={options}
            ...
            <div className="mt-5 z-0">
              ...
              <div className="mt-10">
                <p className="font-poppins font-bold"> Income Amount</p>
                <input
                  value={expense}
                  type="number"
